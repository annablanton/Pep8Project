...
public class HexCalculatorTest {
	...
	private void testOpTypes(int x, int y, int expected, BiFunction<model.Number, model.Number, model.Number> testOp,
			Function<Integer, model.Number> type) {
		testOpTypes(x, y, expected, testOp, type, type);
	}

	private void testOpTypes(int x, int y, int expected, BiFunction<model.Number, model.Number, model.Number> testOp,
			Function<Integer, model.Number> type1, Function<Integer, model.Number> type2) {
