...
/**
 * Class for memory object. Stores byte array with 16-bit addressability.
...
//		System.out.println("getData call" + addr);
	...
	/*
	 * This is an alias of the storeInstruction method. Since instructions and
	 * characters are both bytes, the operations performed are identical, but
	 * explicitly naming this instruction storeCharacter is clearer when calling it
	 * for character input.
	 */
	...
	public void storeByte(short addr, byte... d) {
		storeInstruction(addr, d);
	}
