...
public class ALU {
	...
	/**
	 * Adds two shorts together, this method breaks the shorts down to simulate the
	 * internal workings of an ALU.
	 * 
	...
	/**
	 * Subtract two short values, this method breaks them down to simulate the inner
	 * workings of an ALU.
	 * 
