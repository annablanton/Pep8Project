...
/**
 * Concrete Binary class. Creates and stores binary strings from passed integer
 * values.
 */
public class Binary extends Number {
	/**
	 * Binary constructor. Creates a binary string (padded to at least 8 bits) and
	 * passes the string to the Number constructor for storage.
	 * 
	...
	/**
	 * Static method to create a binary string left padded to at least 8 bits from
	 * the passed integer.
	 * 
...
//            }
	 ...
	 * 
	 * @param b Binary number for comparison
	 * @return -1 if this Binary object's value is less than passed Binary object's
	 *         value, 0 if equal, 1 if greater than
	 */
	...
	/**
	 * String representation of Binary object's value. Concatenates the string "0b"
	 * with the binary string to indicate that it is a binary string.
	 * 
