...
/**
 * BinaryCalculator class. Contains methods for performing operations on any two
 * Number objects together and returning a Binary object.
 * 
 * @author Anna Blanton
 */
public class BinaryCalculator extends Calculator {
	...
	/**
	 * BinaryCalculator constructor. The BinaryCalculator has no internal state.
	 */
	 ...
	 * 
	 * @param b Binary object to convert Object returned will be functionally
	 *          equivalent to original, but this method is necessary to satisfy
	 *          Converter interface.
	 ...
	 * Binary objects, then applies the passed operation to the integer values for
	 * the Binary objects and returns a new Binary object.
	 * 
