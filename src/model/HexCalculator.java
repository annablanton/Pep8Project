...
/**
 * HexCalculator class. Contains methods for performing operations on any two
 * Number objects together and returning a Hex object.
 * 
 * @author Anna Blanton
 */
public class HexCalculator extends Calculator {
	...
	/**
	 * HexCalculator constructor. The HexCalculator has no internal state.
	 */
	...
	/**
	 * Hex to Hex converter. Object returned will be functionally equivalent to
	 * original, but this method is necessary to satisfy Converter interface.
	 * 
	...
	/**
	 * Helper method for operations. Takes two Number objects, converts them to Hex
	 * objects, then applies the passed operation to the integer values for the Hex
	 * objects and returns a new Hex object.
	 * 
