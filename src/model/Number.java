...
/**
 * Parent class for concrete Number types. Stores shared behavior for a few
 * functions and handles storage of the actual String value for the Number. This
 * allows callers of its child classes to use integer values which are converted
 * to Strings by the child class which is then passed to the parent class's
 * methods to store.
 * 
 * @author Anna Blanton
 */
public abstract class Number {
	...
	/**
	 * Number constructor. Called by its children's constructors after an initial
	 * string for the val field has been created.
	 * 
	...
	/**
	 * Internal setter for val field. Called by its children's setVal methods to
	 * store the val String.
	 * 
	 ...
	 * 
	 * @param x Number to compare to
	 * @return -1 if this Number object's value is less than passed argument Number
