 ...
 * Primarily contains helper methods for child classes.
 * @author Anna Blanton
 */
public abstract class Calculator implements Convertible {
    /**
     * Calculator constructor.
     * There is no internal state for the calculator.
     */
    public Calculator() {
    ...
    /**
     * Helper convert method for child classes.
     * Determines type of passed Number, then calls child class's convert method for the given type.
