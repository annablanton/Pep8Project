 ...
 * Contains methods for performing operations on any two Number objects together and returning a Decimal object.
 * @author Anna Blanton
 */
public class DecimalCalculator extends Calculator {

    /**
     * DecimalCalculator constructor.
     * The DecimalCalculator has no internal state.
     */
     ...
     * Takes two Number objects, converts them to Decimal objects, then applies the passed operation to the integer values
     * for the Decimal objects and returns a new Decimal object.
