...
/**
 * Concrete Hex class.
 * Creates and stores hex strings from passed integer values.
 */
public class Hex extends Number {
    /**
     * Hex constructor.
     * Creates a hex string (padded to at least 8 bits) and passes the string to the Number constructor for storage.
     ...
     * @param h Hex number for comparison
     * @return -1 if this Hex object's value is less than passed Hex object's value, 0 if equal, 1 if greater than
     */
    ...
    /**
     * String representation of Hex object's value.
     * Concatenates the string "0x" with the hex string to indicate that it is a hex string.
