...
/**
 * Concrete Decimal class.
 * Creates and stores decimal strings from passed integer values.
 */
public class Decimal extends Number {

    /**
     * Decimal constructor.
     * Creates a decimal string and passes the string to the Number constructor for storage.
     ...
     * @param d Decimal number for comparison
     * @return -1 if this Decimal object's value is less than passed Decimal object's value, 0 if equal, 1 if greater than
     */
    ...
    /**
     * String representation of Decimal object's value.
     * Equivalent to getVal() for Decimal.
